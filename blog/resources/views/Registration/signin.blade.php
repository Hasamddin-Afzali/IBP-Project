                ...
                <div class="card-body p-3">
                  ...
                  {{ csrf_field() }}
                    <div class="form-outline">
                      <input type="text" placeholder="Email" name="email" class="form-control mb-3 focus-none">
                    </div>
                    <div class="col">
                      <input type="password" placeholder="Password" name="password" class="form-control mb-3 focus-none">
                    </div>
                    <div class="col">
                      <button type="submit" class="btn btn-success btn-block w-100 mb-3">SIGN IN NOW</button>
                    </div>
                    <div class="col">
                      <a href="" class="text-secondary text-none my-3">Forgot Password?</a>
                    </div>
                    <hr>
                  </form>         
                </div>
